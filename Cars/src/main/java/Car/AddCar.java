...
class AddCar implements ActionListener{
    ...
    AddCar(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Cars/CarIcon/add_employee.jpg"));
        id15.setIcon(img);

        id8 = new JLabel("New Car Details");
        ...
        id4= new JLabel("Date Of Manufacture");  
        ...
        id7= new JLabel("Engine Capacity");
