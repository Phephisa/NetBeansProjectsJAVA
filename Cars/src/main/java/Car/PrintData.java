    ...
    PrintData(String e_id){
        try{
            ...
            while(rs.next()){
                ...
                engnum = rs.getString("engnum");
                engcap = rs.getString("engcap");
                status = rs.getString("status");
                lastservice = rs.getString("lastservice");
                servicedue = rs.getString("servicedue");
